        ...
        def show_home():
            ...
            # Pastikan jurnal sudah ada
                ...
                # Hitung Laba Bersih dari Laba Rugi
                                if "Ikhtisar Laba Rugi" in df["Akun"].values:
                                    ikhtisar = df[df["Akun"] == "Ikhtisar Laba Rugi"]
                                    total_ikhtisar_kredit = ikhtisar["Kredit"].sum()
                                    total_ikhtisar_debit = ikhtisar["Debit"].sum()
                                    laba_bersih = total_ikhtisar_kredit - total_ikhtisar_debit
                                else:
                                    laba_bersih = 0
                ...
                # Kelompokkan akun-akun
                                ...
                                st.write("### Aset")
                                st.dataframe(total_aset.reset_index().rename(columns={"Debit": "Jumlah"}))
